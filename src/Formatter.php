<?php namespace InterestSmart\FnmExporter;

use InterestSmart\FnmExporter\Exception\FieldNotSetException;
use InterestSmart\FnmExporter\Exception\IncorrectlyMappedConditionalException;
use InterestSmart\FnmExporter\Exception\MethodNotSetException;
...
class Formatter
{
     ...
     * @return array|bool
     */
    private function writableRow($parts)
    {   // Keep track of parts of the entire row
        $partsToWrite = [];
